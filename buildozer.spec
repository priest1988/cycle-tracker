...
# use that parameter to set custom Java class instead of PythonActivity
#android.app_class_name = org.kivy.android.PythonActivity
# (str) Java class name for the service
...
# (bool) Use AndroidX support library (recommended)
...
# This was deprecated and replaced by android.archs
...
# 1) android.add_assets = source_dir/assets/filename.ext
# 2) android.add_assets = source_dir/assets
#android.add_assets =
# (list) Gradle dependencies to add
#android.gradle_dependencies =
# (bool) Enable AndroidX support (deprecated, use android.enable_androidx)
...
#android.meta_data =
# (str) Android library project to add (will be added in the
